<div class="pt-10">
    <div class="max-w-2xl px-4 py-12 mx-auto bg-white rounded-lg shadow-lg ">
        <h1 class="mb-6 text-xl">Preencha os Dados do Circuito <span class="font-extrabold">{{$circuit_id}}</span></h1>
            ...
            @if($not_owner_as)
                <div class="mb-4">
                    <span class="text-red-600">
                        Com a finalidade de garantir a lisura e a correta propagação dos prefixos anunciados, solicitamos a gentileza de encaminhar a LOA (Letter Of Aggrement) autorizando seu ASN anunciar os prefixos informados para o email <b>engenharia@altarede.com.br</b>
                        <p>
                            Caso não encontremos a LOA junto ao processo de liberação do peering, essa requisição será rejeitada.
                        </p>
                    </span>
